...
func check_game_state() -> void:
	...
	var sLevel = GameManager.get_level_selected()
	
	game_over_ui.game_over(sLevel, _total_moves)
	hud.hide()
	ScoreSync.level_completed(sLevel, _total_moves)
...
func setup_level() -> void:
	...
	for lName in LAYER_MAP.keys():
		add_layer_tiles(level_tiles[lName], lName)
